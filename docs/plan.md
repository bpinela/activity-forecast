...
Added after submission-ready: harden the workspace with beneficial structural
conventions — apps/ layout, frontend tests, Node version enforcement, CI.
...
- [ ] Deliberately NOT adopted: `packages/scoring`
